...
public class PlayerMotorSelf : MonoBehaviour
{
    public int playerID;
    ...
    void Awake()
    {
        ...
        Random.InitState((int)System.DateTime.Now.Ticks + gameMgr.selfID);
        rb = GetComponent<Rigidbody>();
        rb.position = new Vector3(Random.Range(-295f, -250f), 10f ,Random.Range(20f,65f));
        ground = false;
    }
    void Start()
    {
